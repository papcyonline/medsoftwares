...
const contactMethods = [
  ...
  {
    title: 'Partnerships',
    description: 'Explore partnership and reseller opportunities.',
    email: 'partners@medsoftware.com',
...
const offices = [
  {
    city: 'Accra',
    country: 'Ghana (HQ)',
    address: '25 Independence Avenue, Osu, Accra',
    phone: '+233 20 123 4567',
  },
  {
    city: 'Lagos',
  ...
  },
  {
    city: 'Nairobi',
    country: 'Kenya',
    address: '42 Westlands Road, Nairobi',
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="hospix">Hospix Questions</option>
