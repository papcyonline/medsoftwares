...
import { hospitalOSJsonLd, hospitalOSFaqJsonLd, hospitalOSFaqs } from './metadata';
...
export default function HospitalOSPage() {
  ...
  return (
    <>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(hospitalOSFaqJsonLd) }}
      />
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10 md:mb-14">
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
                Watch how HospitalOS transforms hospital operations with integrated modules for every department.
              </p>
            </div>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-gray-900">
              <div className="aspect-video">
                <iframe
                  src="https://www.youtube.com/embed/D618CdZ7IjI?rel=0"
                  title="HospitalOS Demo Video"
            ...
            <div className="mt-8 text-center">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#1e40af] text-white font-semibold rounded-full hover:bg-[#1e3a8a] transition-colors"
              >
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-14">
              ...
              <p className="text-lg md:text-xl text-gray-600">
                Common questions about HospitalOS hospital management software.
              </p>
            </div>
            <div className="space-y-4">
              {hospitalOSFaqs.map((faq, index) => (
                <details
                  key={index}
                  className="group bg-white rounded-xl border border-gray-200 overflow-hidden"
                >
                  <summary className="flex items-center justify-between gap-4 p-6 cursor-pointer list-none font-semibold text-gray-900 hover:text-[#1e40af] transition-colors">
                    {faq.question}
