        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/pharmapos" className="text-gray-600 hover:text-[#166534] transition-colors text-sm">PharmaPOS</Link></li>
              <li><Link href="/hospix" className="text-gray-600 hover:text-[#166534] transition-colors text-sm">Hospix (HMS)</Link></li>
              <li><Link href="/#features" className="text-gray-600 hover:text-[#166534] transition-colors text-sm">Features</Link></li>
              <li><Link href="/pricing" className="text-gray-600 hover:text-[#166534] transition-colors text-sm">Pricing</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/about" className="text-gray-600 hover:text-[#166534] transition-colors text-sm">About Us</Link></li>
              <li><Link href="/news" className="text-gray-600 hover:text-[#166534] transition-colors text-sm">News & Media</Link></li>
              <li><Link href="/contact" className="text-gray-600 hover:text-[#166534] transition-colors text-sm">Contact</Link></li>
              <li><Link href="/#testimonials" className="text-gray-600 hover:text-[#166534] transition-colors text-sm">Testimonials</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/contact" className="text-gray-600 hover:text-[#166534] transition-colors text-sm">Contact Support</Link></li>
